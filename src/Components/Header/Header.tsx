export default function Header() {
    return (
        <header className="w-full relative  h-[729px] ">
            <img
            ...
            <div className="absolute top-55 left-20 flex flex-col gap-5">
                ...
                <div className="flex gap-5 mt-5">
                    <button className="px-[55px]  py-[5px] rounded-[10px] bg-[#DA392B] hover:bg-white hover:text-black transition-all ease-in duration-00 text-[18px] text-white">Get
                        Now</button>
