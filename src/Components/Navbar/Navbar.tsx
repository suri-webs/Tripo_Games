...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full h-[90px] max-lg:h-[70px] flex justify-between items-start z-50 px-[80px] max-md:px-[10px]">
            <Link
                href="/"
                className="text-[25px] pacifico-regular flex items-center h-[80%] rounded-b-2xl px-6 gap-2 bg-[#DA392B] text-white max-lg:text-2xl"
            >
                Tripo Games
            </Link>
            ...
            <div className="relative w-[20%] z-99 h-full hidden max-lg:flex justify-center">
                ...
                {open && (
                    <ul className="absolute top-full right-0 mt-2 flex flex-col w-[150px] bg-white rounded-lg shadow-lg z-40">
                        ...
                        <li
                            className="relative w-full h-[40px] rounded-b-[10px] group flex justify-end pr-[30px] items-center cursor-pointer hover:bg-[#DA392B] hover:text-white transition-all"
