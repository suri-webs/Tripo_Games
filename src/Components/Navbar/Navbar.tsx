...
export default function Navbar() {
    return (
        <nav className="flex justify-between z-50 items-start fixed top-0 w-full h-[90px] px-[80px] text-black">
            <Link href={"/"} className="text-[25px] pacifico-regular flex items-center h-[80%] rounded-b-2xl px-6 gap-2 bg-[#DA392B] text-white">
                Tripo Games
            </Link>

            <ul className="flex h-[80%] w-[50%] rounded-b-2xl items-center justify-center bg-white text-xl font-sans z-99">
