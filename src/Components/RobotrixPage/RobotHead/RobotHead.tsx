...
export default function RobotHead() {
    return (
        <section className="w-full h-[1100px]  max-md:h-[800px] flex justify-center items-end  bg-[#F6F4F0]">
            <div className="w-full h-[70%] max-md:h-[50%]  relative bg-[url('/Images/Robotrix-Bg.avif')] bg-cover bg-center bg-no-repeat bg-fixed ">
                  ...
                  rounded-3xl px-15 py-20 flex-col bg-white w-[45%]  h-[90%] gap-10 max-md:gap-5  ">
                    <div className="flex gap-7">
                        <span className="shadow-[0_0_10px_#FAC8C7] w-[100px] h-[100px] max-md:w-[80px] max-md:h-[80px] flex justify-center items-center rounded-4xl">
                            <Image className="!w-[85px] max-md:!w-[65px] max-md:!h-[65px] !h-[85px] max-md:rounded-3xl rounded-4xl" src={"/images/Robotrix.avif"} alt="" width={1000} height={100}/>
                        </span>
                        <div className="flex flex-col justify-center">
                            <h2 className="text-3xl max-md:text-2xl text-[#272443] suez-regular">{"Robotrix"}</h2>
                            <p className="text-[22px] max-md:text-[17px]">{"RPG - Free"}</p>
                        </div>
                    </div>

                    <p className='text-5xl max-md:text-3xl  max-md:leading-9 max-sm:leading-7 max-sm:text-xl max-md:w-full suez-regular leading-15 text-[#272443] w-full'>{"Enjoy Tactical Combat and Secrets to Find With Robotrix."}</p>
