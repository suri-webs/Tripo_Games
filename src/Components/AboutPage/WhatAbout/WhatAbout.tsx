            ...
            <div className="z-89 flex justify-center items-center flex-col gap-15">
                ...
                <div className="flex justify-center items-center gap-10 ">
                    {WhatTextData.map((items, index) => {
                        return (
                            <ul key={index} className="w-[28%] p-[40px] rounded-3xl h-[250px] bg-white shadow-2xl flex flex-col gap-5">
                ...
                {WhatTextData2.map((items, index) => {
                    return (
                        <ul key={index} className="w-[58.5%] p-[40px] rounded-3xl h-[200px] bg-white shadow-2xl flex flex-col gap-5">
                            <li className="text-3xl font-sans font-medium text-[#DA392B]">{items.heading}</li>
                            <li className="text-[17px]">{items.paragraph}</li>
                        </ul>
                    )
