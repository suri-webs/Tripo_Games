export default function GetinTouch() {
    return (
        <section className="w-full h-[600px] bg-[url('/Images/Star-Bg-fixed.avif')] bg-cover  bg-center bg-no-repeat bg-fixed relative">
            ...
            <div className="w-[30%] max-md:w-[85%] p-7 absolute flex flex-col justify-evenly gap-5 right-40 bottom-30 h-[300px] bg-[#DA392B] rounded-3xl max-md:right-[30px]">
                <h4 className="text-[24px] font-medium text-white max-md:text-[19px]">Subscribe to Our Newsletter</h4>
                <div className="flex flex-col gap-2 ">
                    <p className="text-xl text-white">Email*</p>
                    <input type="email" className=" w-[100%] max-md:h-[35px] border border-[#ffffff41] bg-[#ffffff41] h-[45px] rounded-xl" />

                </div>
                <div className="w-full flex items-center justify-center gap-2 max-md:gap-5">
                    <span className="border border-white  w-[20px] h-[20px]"></span>
                    <p className="text-[15px] text-white w-[250px] max-md:whitespace-nowrap max-md:w-[110px] max-md:overflow-hidden">Yes, subscribe me to your newsletter. *</p>
