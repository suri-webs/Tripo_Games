                  ...
                  rounded-3xl px-15 py-20 flex-col bg-white w-[45%]  h-[90%] gap-10 max-md:gap-5 ">
                    <div className="flex  gap-7">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <p className="text-[22px] max-md:text-[17px]">{"Casual - Free"}</p>
                        </div>
                    </div>

                    <p className='text-5xl max-md:text-3xl  max-md:leading-9 max-sm:leading-7 max-sm:text-xl max-md:w-full suez-regular leading-15 text-[#272443] w-full'>{"A One-of-a-Kind Game That Offers Endless Excitement at Your Fingertips."}</p>
