...
export default function ContactPage() {
    return (
        <>
            <section className="w-full h-[600px] max-md:h-full max-md:p-5 p-[70px] max-md:py-25  flex justify-center items-center pb-[80px] bg-[#F6F4F0]">
                <div className="flex w-[95%]  flex-col gap-7">
                    ...
                    <p className="text-[18px] font-medium  text-[#636161] max-md:w-[90%] w-[45%]">
